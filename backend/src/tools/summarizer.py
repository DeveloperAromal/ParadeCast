...
from src.agent.agent_prompt import summarizer
import re

def final_output_data_processing_agent(lat, lon, days):
    load_raw_file = os.path.join("src/db/raw", "agent_full_log.txt")
    ...
    prompt = summarizer(lat, lon, days, raw_data)
